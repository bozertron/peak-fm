...
| [240](PEAK-240-invite-redemption.md) | **1** | Beta invite redemption | PEAK-203, PEAK-204 | **DONE — verified** (W-PEAK-01a + closure-2, 2026-09-19) — enforced at the real endpoint, 13 attack classes refused, final-use race proven with a deterministic barrier, 240.A7 render proof on disk. *(One named coverage hole: the wire transport at `auth-form.tsx:71` is implemented but not observed by a test.)* |
